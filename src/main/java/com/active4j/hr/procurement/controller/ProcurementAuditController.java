 ...
 */
@Controller
@RequestMapping("govprocurement/audit")
@Slf4j
public class ProcurementAuditController {
    ...
    public ModelAndView show(HttpServletRequest request) {
        ModelAndView view = new ModelAndView("procurement/procurementAudit");
        return view;
    }
    ...
    public ModelAndView list(HttpServletRequest req) {
        ...
        for (int i = size - 1; i >= 0; i--) {
            ...
            if (catogorys.getName().equals("政采审批")) {
    ...
    public ModelAndView groupwaittasklist(HttpServletRequest req) {
        ModelAndView view = new ModelAndView("procurement/procurementgroupwaittasklist");
