...
public class WorkflowServiceImpl implements WorkflowService {
    ...
    public IPage<WorkflowBaseEntity> findFinishedTaskByUserName(IPage<WorkflowBaseEntity> page, WorkflowBaseEntity base, String startTime, String endTime, String userName, String category) {
        ...
        return workflowDao.findFinishedTaskByUserName(page, userName, base.getCategoryId(), base.getProjectNo(), base.getName(), base.getApplyName(), base.getApplyerDepart(), startTime, endTime);
    }
    ...
    public IPage<WorkflowBaseEntity> findFinishedTaskByALL(IPage<WorkflowBaseEntity> page, WorkflowBaseEntity base, String startTime, String endTime, String category) {
        ...
        return workflowDao.findFinishedTaskByALL(page, base.getCategoryId(), base.getProjectNo(), base.getName(), base.getApplyName(), base.getApplyerDepart(), startTime, endTime);
    }
    ...
    public IPage<WorkflowBaseEntity> findTaskStrsByUserName(IPage<WorkflowBaseEntity> page, WorkflowBaseEntity base, String startTime, String endTime, String userName, String category) {
        ...
        //方法优化，直接改用sql查出结果
        return workflowDao.findTaskStrsByUserName(page, userName, base.getCategoryId(), base.getProjectNo(), base.getName(), base.getApplyName(), base.getApplyerDepart(), startTime, endTime);
    }
    ...
    public IPage<WorkflowBaseEntity> findGroupTaskStrsByUserName(IPage<WorkflowBaseEntity> page, WorkflowBaseEntity base, String startTime, String endTime, String userName) {
        return workflowDao.findGroupTaskStrsByUserName(page, userName, base.getCategoryId(), base.getProjectNo(), base.getName(), base.getApplyName(), base.getApplyerDepart(), startTime, endTime);
    }

    /**
     * @return List<String>
     * @description 查询用户代办组任务，拾取任务
     * @author xfzhang
    ...
    @Override
    public IPage<HashMap> findFinishedTaskSealByUserDept(Page<WorkflowBaseEntity> page, WorkflowBaseEntity base, String sealtype, String user_name,String userDept, String startTime, String endTime, String task_category_approval) {
