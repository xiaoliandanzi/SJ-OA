...
public interface CarRecordDao {
    List<FlowCarApprovalEntity> getAllCarMessage(@Param("useDepatment") String useDepatment, @Param("applyDate_begin") String applyDate_begin,@Param("applyDate_end") String applyDate_end);
