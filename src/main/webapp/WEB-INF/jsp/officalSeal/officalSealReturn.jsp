        ...
        <div class="col-sm-12">
            ...
            <div class="ibox">
                <div class="ibox-content">
                    <div id="officalSealReturn" class="jqGrid_wrapper"></div>
                </div>
            </div>
        </div>
    </div>
...
<!-- 脚本部分 -->
<t:datagrid actionUrl="car/manage/datagrid" tableContentId="officalSealReturn" searchGroupId="searchGroupId" fit="true" caption="公章归还" name="officalSealList" pageSize="20" sortName="createDate" sortOrder="desc">
