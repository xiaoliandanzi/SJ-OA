...
<!-- 脚本部分 -->
<t:datagrid actionUrl="officalSeal/return/datagridFinish" tableContentId="finishTaskTable" searchGroupId="searchGroupId" fit="true" caption="公章使用记录" name="finishTaskList" sortName="useDay" pageSize="20">
    ...
    <t:dgCol name="useDay" label="使用时间" width="120" query="true" datefmt="yyyy-MM-dd" queryModel="group" datePlugin="laydate"></t:dgCol>
    <%--<t:dgCol name="projectNo" label="编号" width="120" ></t:dgCol>--%>
<%--    <t:dgCol name="name" label="标题名称" width="120" query="true"></t:dgCol>--%>
    <t:dgCol name="applyStatus" label="状态" width="70" dictionary="actstatus" classes="text-navy"></t:dgCol>
    <t:dgCol name="level" label="紧急程度" width="70" dictionary="workflowlevel" display="level" hidden="true"></t:dgCol>
    <t:dgCol name="departmentName" label="申请科室" width="80" query="true"></t:dgCol>
