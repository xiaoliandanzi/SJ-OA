...
<%--                </li>--%>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header" style="width: 700px"><a
                    ...
                    <div style="float: left"><img src="img/1.png " style="width: 46px;height: 46px">
                        <a href="/oa/" style="color: #347BB7; font-size: 19px;position: relative;top: 8px"><b>双井街道智慧办公系统&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
                    </div>
                    <div style="float: left"><img src="img/首页@2x.png" class="ban">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info J_menuItem6" data-toggle="dropdown"
                           href="oaInfoMailController.do?list" title="收件箱">
        ...
        <div class="row content-tabs">
            ...
            <a href="javascript:;" class="roll-nav roll-right J_tabExit" onclick="exit();"><i
