...
<!-- 脚本部分 -->
<t:datagrid actionUrl="asset/manage/approval/datagrid" tableContentId="waitTaskTable" searchGroupId="searchGroupId" fit="true" caption="审核列表" name="assetManageList" pageSize="20" sortName="createDate" sortOrder="desc">
    ...
    <t:dgCol name="workFlowName" hidden="true" label="流程名称" width="70"></t:dgCol>
