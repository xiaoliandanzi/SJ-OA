...
<!-- 脚本部分 -->
<t:datagrid actionUrl="asset/manage/approval/adddatagrid" tableContentId="waitTaskTable" searchGroupId="searchGroupId" fit="true" caption="待审批固定资产入库申请" name="waitTaskList" pageSize="20" sortName="applyDate" sortOrder="desc">
