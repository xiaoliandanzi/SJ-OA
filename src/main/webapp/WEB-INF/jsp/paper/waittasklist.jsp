...
<!-- 脚本部分 -->
<t:datagrid actionUrl="paper/apply/datagrid" tableContentId="waitTaskTable" searchGroupId="searchGroupId" fit="true" caption="待审批任务" name="waitTaskList" pageSize="20" sortName="applyDate" sortOrder="desc">
