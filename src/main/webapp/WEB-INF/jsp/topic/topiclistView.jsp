...
<t:datagrid actionUrl="topic/viewtable" tableContentId="jqGrid_wrapper" searchGroupId="searchGroupId" fit="true"
    ...
    <t:dgCol name="isPassFour" label="财务审查" query="false" replace="驳回_2,通过_1, _0" align="center"></t:dgCol>
    <t:dgCol name="isPassFive" label="纪检审查" query="false" replace="驳回_2,通过_1, _0" align="center"></t:dgCol>
