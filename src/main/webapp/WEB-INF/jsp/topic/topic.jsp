					...
					<div class="ibox-content">
						<t:formvalid action="sys/user/saveUser">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="userName" name="deptLeaderId" <c:if test="${not empty user.id }">readonly="readonly"</c:if> minlength="2" maxlength="20" type="text" class="form-control" required="" value="${user.userName }">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">汇报人*：</label>
                                <div class="col-sm-8">
                                    <input id="realName" name="reportId" minlength="2" maxlength="10" type="text" class="form-control" required="" value="${user.realName }">
                                </div>
                            </div>
