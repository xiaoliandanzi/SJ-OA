                ...
                <div class="ibox-content">
                    <t:formvalid action="meeting/edit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="meetingName" name="meetingName" minlength="2"   value="${meetingName}"  type="text" class="form-control" required=""  >
                            </div>
                        </div>
                        <div class="form-group">
...
<t:datagrid actionUrl="meeting/tablebianji"   tableContentId="topictable" searchGroupId="searchGroupId" fit="true"
    ...
    <t:dgCol name="isPassFour" label="财务审核" query="false" replace="驳回_2,通过_1, _0"></t:dgCol>
    <t:dgCol name="isPassFive" label="纪检审核" query="false" replace="驳回_2,通过_1, _0"></t:dgCol>
